        ...
        <>
            ...
            <motion.div id='gallery'  animate={{opacity:[0,1]}} transition={{delay:1.5}} onClick={handleCarousel} class=" absolute cursor-pointer hover:bg-gray-600 xl:w-auto lg:w-auto md:w-auto sm:w-auto xs:w-screen sm:hover:scale-105 xs:hover:scale-100 transition-all active:bg-gray-500  p-1 xs:rounded-none md:rounded-md sm:rounded-md xl:rounded-md lg:rounded-md xl:mt-[1.2%] lg:mt-[1.2%] sm:mt-[2.3%] md:mt-[0.98%] xs:mt-[9%] xl:right-[8.5%] lg:right-[8.5%] md:right-[8.5%] sm:right-[8.5%] xs:right-0  flex items-center justify-center bg-gray-700 ">
                ...
                <motion.div  animate={gridAnimation}  class="overflow-y-hidden xl:pb-[2%] lg:pb-[2%] md:pb-[2%] sm:pb-[2%] xs:pb-[12%]  ml-[6%]  bg-oran w-full h-auto xl:pt-[4.5%] md:pt-[5%] sm:pt-[8%]  lg:pt-[4.5%] xs:pt-[24%]" >
                  <motion.img  whileHover={{scale:1.05}}  transition={{ type:'spring'}} src="/IMG_0170.JPG" className='w-[15%] brightness-125 h-[42%] p-[7px] inline' alt="" />
                  <motion.img whileHover={{scale:1.05}}  transition={{type:'spring'}} src="/IMG_0172.jpg" className='w-[15%] brightness-[140%] h-[42%]  p-[7px] inline ' alt="" />
                  <motion.img whileHover={{scale:1.05}}  transition={{type:'spring'}} src="/IMG_0244.jpg" className=' w-[26%] brightness-[125%] h-[42%]  p-[7px] inline ' alt="" />
                  <motion.img whileHover={{scale:1.05}}  transition={{type:'spring'}} src="/IMG_0245.jpg" className='w-[15%] brightness-[135%] h-[42%]  p-[7px] inline ' alt="" />
                  <motion.img whileHover={{scale:1.05}}  transition={{type:'spring'}} src="/IMG_0239.jpg" className='w-[15%] brightness-[125%] h-[42%]  p-[7px] inline ' alt="" />
                  <motion.img whileHover={{scale:1.05}}  transition={{type:'spring'}} src="/IMG_0224.jpg" className='w-[15%] brightness-[125%] h-[42%]  p-[7px] inline ' alt="" />
                  <motion.img whileHover={{scale:1.05}}  transition={{type:'spring'}} src="/IMG_0174.jpg" className='w-[15%] brightness-[125%] h-[42%]  p-[7px] inline ' alt="" />
                  <motion.img whileHover={{scale:1.05}}  transition={{type:'spring'}} src="/IMG_0169.jpg" className='w-[15%] brightness-[132%] h-[42%]  p-[7px] inline ' alt="" />
                  <motion.img whileHover={{scale:1.05}}  transition={{type:'spring'}} src="/IMG_0234.jpg" className='w-[26%] brightness-[130%] h-[42%]  p-[7px] inline ' alt="" />
                  <motion.img whileHover={{scale:1.05}}  transition={{type:'spring'}} src="/IMG_0230.jpg" className='w-[15%] brightness-[130%] h-[42%]  p-[7px] inline ' alt="" />
                  <motion.img whileHover={{scale:1.03}}  transition={{type:'spring'}} src="/IMG_0175.jpg" className='w-[26%] brightness-[130%] h-[42%]  p-[7px] inline ' alt="" />
                  <motion.img whileHover={{scale:1.03}}  transition={{type:'spring'}} src="/IMG_0176.jpg" className='w-[26%] brightness-[130%] h-[42%]  p-[7px] inline ' alt="" />
                  <motion.img whileHover={{scale:1.03}}  transition={{type:'spring'}} src="/IMG_0238.jpg" className='w-[15%] brightness-[130%] h-[42%]  p-[7px] inline ' alt="" />
                  <motion.img whileHover={{scale:1.03}}  transition={{type:'spring'}} src="/IMG_0241.jpg" className='w-[26%] brightness-[130%] h-[42%]  p-[7px] inline ' alt="" />
                  <motion.img whileHover={{scale:1.03}}  transition={{type:'spring'}} src="/IMG_0178.jpg" className='w-[15%] brightness-[130%] h-[42%]  p-[7px] inline ' alt="" />
                  <motion.img whileHover={{scale:1.03}}  transition={{type:'spring'}} src="/IMG_0188.jpg" className='w-[15%] brightness-[130%] h-[42%]  p-[7px] inline ' alt="" />
                  <motion.img whileHover={{scale:1.03}}  transition={{type:'spring'}} src="/IMG_0177.jpg" className='w-[15%] brightness-[140%] h-[42%]  p-[7px] inline ' alt="" />
                  <motion.img whileHover={{scale:1.03}}  transition={{type:'spring'}} src="/IMG_0186.jpg" className='w-[15%] brightness-[130%] h-[42%]  p-[7px] inline ' alt="" />
                  <motion.img whileHover={{scale:1.03}}  transition={{type:'spring'}} src="/IMG_0223.jpg" className='w-[26%] brightness-[125%] h-[42%]  p-[7px] inline ' alt="" />
                  <motion.img whileHover={{scale:1.03}}  transition={{type:'spring'}} src="/IMG_0225.jpg" className='w-[15%] brightness-[125%] h-[42%]  p-[7px] inline ' alt="" />
                </motion.div>
            </div>
        </>
    )
