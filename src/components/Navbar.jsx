...
export default function Navbar() {
    ...
    return (
        <>
            ...
            <Link path to='/'>
                <motion.img whileHover={{scale:1.05}} transition={{type:'spring', duration: .7}} alt="KB's Kustomz custom paint and autobody logo" className=" sm:w-[95px] text-white text-[8px] absolute top-[-4.8px] pb-[0px] xs:w-[65px] md:w-[110px] xl:w-[130px] lg:w-[130px] " src="public/Images/logo.png"></motion.img>
            </Link>
