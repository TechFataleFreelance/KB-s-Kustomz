    ...
    return (
        <>
            <motion.nav animate={{ opacity: [0, 1] }} viewport={{ once: true }} transition={{ duration: 1, delay: 1 }} class="sticky z-10 bg-gray-200 top-0 w-full h-[15%]">
                <Link path to='/'>
                    <motion.img whileHover={{ scale: 1.05 }} transition={{ type: 'spring', duration: .7 }} alt="KB's Kustomz custom paint and autobody logo" className=" sm:w-[95px] text-white text-[8px] absolute top-[-4.8px] pb-[0px] xs:w-[65px] md:w-[110px] xl:w-[130px] lg:w-[130px] " src="/Images/logo.png"></motion.img>
                </Link>
