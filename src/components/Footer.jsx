    ...
    return (
        <div className="h-[40%] w-full bg-black border-white border-solid border-t-[1px] flex">
            ...
            <div className='w-[50%]'>
                ...
                <div className='w-full font-glacial  h-[70%] flex flex-col justify-evenly  '>
                    <h2 className='text-white flex  items-center font-sans pl-[5%] w-full'><span className='font-glacialBold pr-[5px]'>Email:</span>korybrown24@gmail.com</h2>
                    <h2 className='text-white flex items-center pl-[5%] w-full'><span className='font-glacialBold pr-[5px]'>Phone Number:</span>815-751-7039</h2>
                    <h2 className='text-white flex items-center pl-[5%] w-full'><span className='font-glacialBold pr-[5px]'>Address:</span>13845 1650 North Ave Wyanet, IL 61379</h2>
